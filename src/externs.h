...
extern bool suppress_travel_resume_prompt_hack;
...
extern bool display_percentages; /* Display percentages rather than status bars */
...
extern bool display_upkeep_bar; /* Display remaining pet control like a health bar */
...
extern bool autopick_update_legacy_pref_file(cptr name);
...
extern void do_cmd_spike_dir(int dir);
extern void do_cmd_walk(bool pickup);
extern int walking_energy_use(bool on_world_map);
...
extern bool journey_find(char key, int *x_ptr, int *y_ptr);
extern bool journey_find_any(char key, int *x_ptr, int *y_ptr);
extern bool journey_available(char key);
extern bool journey_underfoot_only(char key);
extern cptr journey_label(char key);
extern void journey_report_failure(char key);
extern bool journey_key(char key);
extern bool journey_key_any(char key);
extern char journey_choose_list(void);
...
extern bool frox_import_available(void);
extern void frox_import_startup_prompt(void);
extern bool frox_import_manual(void);
extern void process_player_name(bool sf);
extern void get_player_base_name(char *buf, int max);
...
extern int package_test_run(bool headless);
extern int package_test_finish(int status);
extern void package_test_log(cptr fmt, ...);
...
extern int monster_move_energy(monster_type *m_ptr, int y, int x);
extern bool pet_find_shove_grid(monster_type *m_ptr, int *ty, int *tx, int *energy);
extern bool pet_shove_aside(int m_idx);
...
extern int mon_display_instance_target(monster_type *mon);
...
extern void obj_display_inspect(object_type *o_ptr);
...
extern int detect_objects_gold(int range);
extern int detect_objects_normal(int range);
...
extern bool tgt_pt_travel(int *x_ptr, int *y_ptr);
