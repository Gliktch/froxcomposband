...
static _parse_t _annoy_tbl[] = {
    { "AMNESIA", { MST_ANNOY, ANNOY_AMNESIA },
        { "Amnesia", TERM_L_BLUE,
          ...
          "$CASTER tries to blank your mind.",
          "$CASTER tries to blank $TARGET's mind."}, MSF_TARGET | MSF_DIRECT},
    ...
    { "BLIND", { MST_ANNOY, ANNOY_BLIND },
        { "Blind", TERM_ORANGE,
          ...
          "$CASTER mumbles.",
          "$CASTER casts a spell, burning $TARGET's eyes!"}, MSF_TARGET | MSF_DIRECT},
    { "CONFUSE", { MST_ANNOY, ANNOY_CONFUSE },
        { "Confuse", TERM_L_UMBER,
          ...
          "$CASTER creates a mesmerizing illusion around $TARGET."}, MSF_TARGET | MSF_DIRECT},
    ...
    { "PARALYZE", { MST_ANNOY, ANNOY_PARALYZE },
        { "Paralyze", TERM_RED,
          ...
          "$CASTER mumbles.",
          "$CASTER stares deep into $TARGET's eyes!"}, MSF_TARGET},
    { "SCARE", { MST_ANNOY, ANNOY_SCARE },
        { "Terrify", TERM_RED,
          "$CASTER casts a fearful illusion.",
          "$CASTER mumbles, and you hear scary noises.",
          "$CASTER casts a fearful illusion around $TARGET."}, MSF_TARGET | MSF_DIRECT},
    { "SLOW", { MST_ANNOY, ANNOY_SLOW },
        { "Slow", TERM_SLATE,
          "$CASTER drains power from your muscles!",
          "$CASTER drains power from your muscles!",
          "$CASTER drains power from $TARGET's muscles!"}, MSF_TARGET | MSF_DIRECT},
    ...
    { "TELE_LEVEL", { MST_ANNOY, ANNOY_TELE_LEVEL },
        { "Teleport Level", TERM_WHITE,
          ...
          "$CASTER gestures at $TARGET's feet."}, MSF_TARGET | MSF_DIRECT},
...
static _parse_t _biff_tbl[] = {
    { "ANTI_MAGIC", { MST_BIFF, BIFF_ANTI_MAGIC },
        { "Anti-Magic", TERM_L_BLUE,
          ...
          "$CASTER invokes <color:B>Anti-Magic</color> against $TARGET.",
    ...
    { "DISPEL_MAGIC", { MST_BIFF, BIFF_DISPEL_MAGIC },
        { "Dispel Magic", TERM_L_BLUE,
          ...
          "$CASTER mumbles powerfully.",
          "$CASTER invokes <color:B>Dispel Magic</color> against $TARGET.",
    ...
    { "POLYMORPH", { MST_BIFF, BIFF_POLYMORPH },
        { "Polymorph Other", TERM_RED,
          ...
          "$CASTER mumbles powerfully.",
          "$CASTER invokes <color:r>Polymorph Other</color> against $TARGET.",
...
static _parse_t _escape_tbl[] = {
    { "TELE_OTHER", { MST_ESCAPE, ESCAPE_TELE_OTHER },
        { "Teleport Away", TERM_WHITE,
          "",
          "",
          "$CASTER teleports $TARGET away." }, MSF_TARGET | MSF_DIRECT },
...
static _parse_t _tactic_tbl[] = {
    ...
    { "BLINK_OTHER", { MST_TACTIC, TACTIC_BLINK_OTHER },
        { "Blink Away", TERM_WHITE,
          "",
          "",
          "$CASTER blinks $TARGET away." }, MSF_TARGET | MSF_DIRECT },
    {0}
};
