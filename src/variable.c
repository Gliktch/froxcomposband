...
s16b fetch_cycle_o_idx;      /* Show this object while cycling fetch targets */
...
byte always_repeat_count = 100; /* Retry count for obvious commands */
...
bool failed_item_retry_count_dummy;
byte failed_item_retry_count = 0;
...
byte map_edge_center_distance = 5;
...
bool show_damage_hp; /* Use live HP for single-monster damage estimates in monster info */
